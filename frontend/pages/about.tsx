...
const About: NextPage = () => {
  return (
    <>
      <Head>
        <title>About | IT Memes World</title>
      </Head>
      <Container maxWidth='lg'>
        <div>
          ...
          <Text>
            ...
            For now, you can either scroll through the memes anonymously or
            create an account and like/dislike or add new memes.
          </Text>
          <Text>
            If you would like to know what I have planned for this site or
            simply what to check out my code, visit the GitHub repository:{' '}
            <a href='https://github.com/Nikara4/MERN_it_memes_website/'>
              MERN_it_memes_website
            </a>
            . Should you have any ideas, on how to build this site or want to
            let me know what to code better, feel free to contact me.
          </Text>
          <Text>
            <a href='https://github.com/Nikara4/MERN_it_memes_website/'>
              Portfolio
            ...
            /{' '}
            <a href='https://www.linkedin.com/in/aleksandra-szczur/'>
              LinkedIn
            </a>{' '}
